...
public class JsonTool {
    ...
    public static void setConvertDepth(int convertDepth) {
        ...
        JsonTool.convertDepth = convertDepth;
    }
    ...
    public static void setTimestampPattern(String timestampPattern) {
        ...
        JsonTool.timestampPattern = timestampPattern;
    }
    ...
    public static void setDatePattern(String datePattern) {
        ...
        JsonTool.datePattern = datePattern;
    }
                ...
                if (!"Class".equals(attrName)) {				// Ignore Object.getClass()
                    ...
                    if (types.length == 0) {
                        try {
                            ...
                            map.put(StringTool.firstCharToLowerCase(attrName), value);
                        } catch (Exception e) {
